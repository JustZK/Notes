...
public class AnimationActivityAdapter extends RecyclerView.Adapter<AnimationActivityAdapter.ViewHolder>{
    private Context mContext;
    private ArrayList<String> list;
    private LayoutInflater inflater;
    private OnItemClickListener mOnItemClickListener;

    public AnimationActivityAdapter(Context mContext, ArrayList<String> list) {
