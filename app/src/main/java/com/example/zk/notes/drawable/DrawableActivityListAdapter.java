...
public class DrawableActivityListAdapter extends RecyclerView.Adapter<DrawableActivityListAdapter.ViewHolder>{
    private Context mContext;
    private ArrayList<String> list;
    private LayoutInflater inflater;
    private OnItemClickListener mOnItemClickListener;

    public DrawableActivityListAdapter(Context mContext, ArrayList<String> list) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        holder.item_text_view_tv.setText(list.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        protected TextView item_text_view_tv;

        public ViewHolder(View view) {
            super(view);
            item_text_view_tv = (TextView) view.findViewById(R.id.item_text_view_tv);
        }
    }
}
